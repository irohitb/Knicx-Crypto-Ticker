...
class cryptoProfile extends PureComponent {
    constructor() {
        ...
        this.spaceyfiLogo = (<Image source={require('./../../images/spaceyfi.png')}  style={img} />) 
               ...
               <View>
                 ...
                 <ScrollView>
                    ...
                    <View style={connectHeading}>
                        <Text style={textconnectHeading}> Connect with Us on..</Text>
                            <View style={tab}>
                                ...
                                <TouchableOpacity style={[socialTouchableText, {backgroundColor: "#E91E63"}]}
                                 onPress={() => {
                                    ...
                                    const FANPAGE_URL_FOR_APP = `instagram://user?username=irohitb`
                    ...
                    <View style={coffee}>
                        ...
                        <Text style={coffeText}> I (as in creator of this app) am always excited to meet with crazy entrepreneurs building interesting stuff to people having some crazy stories to share. 
